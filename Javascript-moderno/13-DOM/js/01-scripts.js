...
// Gracias al DOM podemos hacer referencia a cualquier elemento del documento HTML.
let elemento;

elemento = document;
elemento = document.all;  // Obtiene todos los elementos de html tags/clases/ids
